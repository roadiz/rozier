    ...
    $.fn.tagEditor = function (options, val, blur) {
        ...
        if (typeof options == 'string') {
            ...
            selector.each(function () {
                ...
                if (options == 'getTags') response.push({ field: el[0], editor: ed, tags: ed.data('tags') })
                            ...
                            var sel = getSelection(),
                                el =
                                    document.activeElement.tagName == 'BODY'
                                        ? $(sel.getRangeAt(0).startContainer.parentNode).closest('.tag-editor')
                                        : 0
                        } catch (e) {
                            el = 0
                        }
        ...
        return selector.each(function () {
            ...
            var ed = $(
                '<ul ' + (o.clickDelete ? 'oncontextmenu="return false;" ' : '') + 'class="tag-editor"></ul>'
            ).insertAfter(el)
            ...
            ed.click(function (e, closest_tag) {
                ...
                // empty editor
                else $(new_tag).appendTo(ed).find('.tag-editor-tag').click()
                return false
            })
            ...
            ed.on('click', '.tag-editor-tag', function (e) {
                ...
                if (!$(this).hasClass('active')) {
                    ...
                    var left_percent = Math.abs(($(this).offset().left - e.pageX) / $(this).width()),
                        ...
                        input = $(this)
                            .html('<input type="text" maxlength="' + o.maxLength + '" value="' + escape(tag) + '">')
                            .addClass('active')
                            .find('input')
                    ...
                    if (o.autocomplete) {
                        ...
                        aco.select = function (e, ui) {
                            ...
                            setTimeout(function () {
                                ed.trigger('click', [
                                    $('.active', ed).find('input').closest('li').next('li').find('.tag-editor-tag'),
                                ])
                            }, 20)
                        }
            ...
            ed.on('keydown', 'input', function (e) {
                ...
                if (
                    ((e.which == 37 || (!o.autocomplete && e.which == 38)) && !$t.caret()) ||
                    (e.which == 8 && !$t.val())
                ) {
